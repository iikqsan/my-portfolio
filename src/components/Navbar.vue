<template>
    <nav class="bg-base-200 text-base-content shadow-md sticky top-0 z-30 bg-opacity-60 backdrop-blur">
            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                    <div class="logo flex flex-shrink-0 items-center">
                        <a href="#">
                            <img v-motion-fade :duration="3500" width="48" height="48" src="https://img.icons8.com/color/48/dev-community.png"
                                alt="dev-community" />
                        </a>
                        <!-- <a href="#" class="btn btn-ghost rounded-md px-3 py-2 text-sm font-medium"> iikqsan logo </a> -->
                    </div>
